      ...
      <main className='min-h-full px-3 my-6 sm:my-auto'>
        <div className='login-container mx-3 h-auto w-auto sm:w-96 bg-white rounded-md p-5 shadow-md'>
          <form id="login" ref={form} onSubmit={handleSubmit} className='flex flex-col'>
            ...
            <input id="username" name="username" className='border border-black rounded mb-3 px-2 py-px' value={username} onChange={e => setUserName(e.target.value)}/>
            <label htmlFor="password" className='font-semibold mb-px'>Password</label>
            <input id="password" name="password" className='border border-black rounded mb-3 px-2 py-px' type="password" value={password} onChange={e => setPassword(e.target.value)}/>
